...
release-rust VERSION:
  ...
  PREV_RE=${PREV//./\\.}
  DATE=$(date +%Y-%m-%d)
  FILES=(crates/jsonschema/Cargo.toml crates/jsonschema-referencing/Cargo.toml crates/jsonschema-cli/Cargo.toml crates/jsonschema-regex/Cargo.toml crates/jsonschema-macros-core/Cargo.toml crates/jsonschema-macros/Cargo.toml crates/jsonschema-wasm/Cargo.toml)
