...
class IfThenElseView:
    __match_args__ = ("condition", "then_branch", "else_branch")
    @property
    def condition(self) -> CanonicalSchema: ...
    @property
    def then_branch(self) -> CanonicalSchema | None: ...
    @property
    def else_branch(self) -> CanonicalSchema | None: ...
