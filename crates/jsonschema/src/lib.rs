...
/// document nesting deeper than [`json::MATERIALIZATION_NESTING_LIMIT`] panics in `validate` and
/// `iter_errors` while
...
pub mod json {
    ...
    #[cfg(feature = "jsonb")]
    pub use jsonschema_value::{Jsonb, JsonbNode, MATERIALIZATION_NESTING_LIMIT};
}
mod http;
mod keywords;
