use crate::{
    canonical::{
        ...
        ir::{
            ArrayLeaf, BoundFraction, BoundInteger, IntegerLeaf, NumberLeaf, ObjectLeaf, Schema,
            SchemaKindSet, SharedSchema, StringLeaf,
        },
        leaves::TypedLeaf,
    },
    JsonTypeSet,
...
pub(crate) struct EmptinessStage;
...
fn fold_fractional_boundary_exclusion(leaf: &NumberLeaf) -> Option<NumberLeaf> {
    ...
    let is_multiple = |value: &BoundFraction| modulus.divides(value);
