...
use crate::{
    canonical::{
        document::{
            contains_dynamic_scope_ref, exceeds_depth_limit, raw_subschema,
            requires_opaque_preservation, validate_schema_document,
        },
...
fn parse_integer_leaf(map: &Map<String, Value>) -> Schema {
    ...
    let multiple_of_fraction = map.get("multipleOf").and_then(parse_bigfraction_value);
