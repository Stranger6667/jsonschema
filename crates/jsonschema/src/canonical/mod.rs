...
//!   `IfThenElse` (a guarded union, always desugared during canonicalization).
...
//!   outside the exactly-representable range, unretrievable references, documents nested past an internal depth
//!   limit - canonicalize *successfully* to an opaque
...
pub use view::{
    ...
    ContentFacetView, NumericView, ObjectConstraintView, ObjectRequirementView, ObjectView,
    StringView, TypedGroupView,
};
