...
/// ```
pub(crate) fn absorb_not_multiple_of_siblings(branches: &mut Vec<SharedSchema>) -> bool {
    ...
    fn numeric_multiple_of_only(schema: &Schema) -> Option<BoundFraction> {
        match schema {
    ...
    fn absorb<M>(
        ...
        extract_moduli: fn(&Schema) -> Option<Vec<M>>,
