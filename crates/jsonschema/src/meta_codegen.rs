...
pub(crate) mod pyo3 {
    ...
    pub type IterErrorsFn = for<'i> fn(&'i Bound<'i, PyAny>) -> PyResult<ErrorIterator<'i>>;
    ...
    /// Every meta-schema error, reading the schema as a Python object.
    #[must_use]
    pub fn iter_errors_fn(draft: Draft) -> IterErrorsFn {
        match draft {
            Draft::Draft4 => MetaDraft4::iter_errors,
            Draft::Draft6 => MetaDraft6::iter_errors,
            Draft::Draft7 => MetaDraft7::iter_errors,
