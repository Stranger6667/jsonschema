...
use super::{
    ...
    stack_emit::{
        ...
        pop_dynamic_validate_v_n, pop_recursive_item_eval, pop_recursive_key_eval,
        pop_recursive_validate, pop_recursive_validate_v, push_dynamic_item_eval,
    ...
    let is_valid_helpers: Vec<TokenStream> = ctx
        ...
        .map(|(fname, body)| {
            ...
            let validate_body = ctx
                ...
                .expect("every is_valid helper stores a validate body");
            quote! {
                #[inline]
