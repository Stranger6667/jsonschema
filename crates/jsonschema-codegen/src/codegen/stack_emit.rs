...
// Parallel stacks for validate(_v) function pointers.
define_recursive_ops!(
...
pub(crate) const VALIDATE_FAMILY: StackFamily = StackFamily {
    push_recursive: push_recursive_validate,
    pop_recursive: pop_recursive_validate,
    push_dynamic: push_dynamic_validate,
    pop_dynamic_n: pop_dynamic_validate_n,
    binding_fn_name: |binding| &binding.validate_name,
};
