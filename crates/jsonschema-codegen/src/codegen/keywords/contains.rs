...
pub(crate) fn compile(
    ...
    // For the combined min+max case, the dynamic validator checks maxContains first
    // (early-return), then minContains. We replicate this using if-else so at most
    // one error is emitted.
