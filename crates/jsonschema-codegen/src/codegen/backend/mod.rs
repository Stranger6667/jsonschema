...
pub(crate) trait BackendAccessors {
    ...
    fn instance_object_property_as_bool(&self, key: &str) -> TokenStream;
    fn instance_object_property_as_i64(&self, key: &str) -> TokenStream;
}
...
pub(crate) trait Backend:
    BackendSymbols + BackendTypeChecks + BackendMatchArms + BackendAccessors + BackendPatterns
{
}

impl<T> Backend for T where
    T: BackendSymbols + BackendTypeChecks + BackendMatchArms + BackendAccessors + BackendPatterns
{
}
