...
// Mirrors the runtime's draft-specific integer typing (Draft 4 does not treat
// integer-valued floats like `-2.0` as integers). The runtime helpers live in
// `jsonschema`, which cannot be a dependency here without a cycle.
